...
<img src="../img/LOGOV.png" alt="" width="70px" height="70px"position:relative >
 ...
 <form action="juguetes.php" method ="POST">
  ...
  <input type="text" name="search" placeholder="Buscar Productos" class="scr" autocomplete="on">
  <imput type="submit" value="Buscar">
</form>
</div>
			<div class="enlaces">
				<a href="../privado/productos/productos.php">Agregar Producto</a>
				<a href="../Perfil/vistaperfil.php">Perfil</a>
				<a href="../privado/queja.php">queja</a>
				<a href="productos/misproductos.php">Mis productos</a>
		...
		<div class="contenedor contenedor-grid">
          ...
          <a href="#" data-categoria="Empresas-Asociadas">Empresas Asociadas <i class="fas fa-angle-right"></i></a>
					<a href="productos/Vista_usu/tecno.php" data-categoria="tecnologia-y-computadoras">Tecnología y Computadoras <i class="fas fa-angle-right"></i></a>
					<a href="productos/Vista_usu/lib.php" data-categoria="libros">Libros <i class="fas fa-angle-right"></i></a>
					<a href="productos/Vista_usu/ropa.php" data-categoria="ropa-y-accesorios">Ropa y Accesorios <i class="fas fa-angle-right"></i></a>
					<a href="productos/Vista_usu/hogar.php" data-categoria="hogar-y-cocina">Hogar y Cocina <i class="fas fa-angle-right"></i></a>
					<a href="productos/Vista_usu/juguetes.php" data-categoria="juegos-y-juguetes">Juegos y Juguetes <i class="fas fa-angle-right"></i></a>
